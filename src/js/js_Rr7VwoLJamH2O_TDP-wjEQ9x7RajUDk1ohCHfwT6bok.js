  ...
  function checkInView() {
    ...
    for (; i < inviewObjects.length; i++) {
      ...
      var top =
        elementOffset.top +
        Number(elementDiff) +
        (triggerOntop ? viewportSize.height * 0.8 : 0);
      if (
...
!(function (e, t, n) {
  ...
  function h(e, t, o, i) {
    ...
    for (d = e.length, p = 0; d > p; p++)
      if (
        ...
        if (N.style[m] != h) return a(), "pfx" == t ? m : !0;
      }
    return a(), !1;
  }
  ...
  var T = "Moz O ms Webkit",
    j = S._config.usePrefixes ? T.split(" ") : [];
  S._cssomPrefixes = j;
  var E = function (t) {
    var r,
      o = b.length,
  ...
  S.atRule = E;
  var P = S._config.usePrefixes ? T.toLowerCase().split(" ") : [];
  S._domPrefixes = P;
  ...
  Modernizr.addTest("objectfit", !!L("objectFit"), { aliases: ["object-fit"] }),
    Modernizr.addTest("csspositionsticky", function () {
      var e = "position:",
        ...
        r = n.style;
      return (
        (r.cssText = e + b.join(t + ";" + e).slice(0, -e.length)),
